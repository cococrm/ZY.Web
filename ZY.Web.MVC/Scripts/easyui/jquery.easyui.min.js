...
$.ajax({
    url: data, data: _510, dataType: "json", beforeSend: function (xhr) {
        ...
        try {
            if (data.status == "401") {
                ...
                parent.$.messager.alert("\u9519\u8bef\u63d0\u793a", "\u4f60\u6ca1\u6709\u64cd\u4f5c\u6743\u9650", "error");
            }
        } catch (e) {
...
$.ajax({
    type: opts.method, url: opts.url, data: _7c5, dataType: "json", beforeSend: function (xhr) {
        xhr.setRequestHeader('Authorization', 'Bearer ' + $.cookie("token"));
    }, success: function (data) {
        try {
            if (data.status == "401") {
